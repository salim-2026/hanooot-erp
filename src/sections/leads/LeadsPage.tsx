...
const Tag = ({ tag }: { tag: string }) => <span className={`rounded-md px-2 py-0.5 text-[10px] font-semibold ${tag.includes("FB") ? "bg-[#e7eefb] text-[#1d4ed8] ring-1 ring-[#c7d6f7]" : tag.includes("follow") ? "bg-[#fbf4e4] text-[#8a5a12] ring-1 ring-[#ebdcbe]" : tag.includes("call") ? "bg-[#fbf4e4] text-[#8a5a12] ring-1 ring-[#ebdcbe]" : "bg-[#f0f0eb] text-[#777a70]"}`}>{tag}</span>
